...
description: This plugin shows a dialog to select the filament when a print on a Prusa printer with MMU2 is startet in single mode.
...
http://plugins.octoprint.org/plugin/mmu2filamentselect/
